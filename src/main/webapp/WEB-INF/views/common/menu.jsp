...
<ul class="nav flex-column">
    ...
    <li class="nav-item mb-2">
     ...
     <li class="nav-item mb-2">
      	<h6 class="text-white">
       		<span class="mr-2">Ch11.</span><a class="text-white" href="${pageContext.request.contextPath}/ch11/content">View/Spring Tag Library</a>
        </h6> 
    </li>
    ...
    <li class="nav-item mb-2">
      	<h6 class="text-white">
       		<span class="mr-2">Ch17.</span><a class="text-white" href="${pageContext.request.contextPath}/ch17/content">Spring Security</a>
        </h6> 
    </li>
</ul>